...
class AddQuranicBenefitScreen extends StatefulWidget {
  final QuranicBenefit? quranicBenefit;
  const AddQuranicBenefitScreen({super.key, this.quranicBenefit});
...
class _AddQuranicBenefitScreenState extends State<AddQuranicBenefitScreen> {
  ...
  @override
  void initState() {
    if (widget.quranicBenefit != null) {
      setState(() {
        controller.text = widget.quranicBenefit!.description!;
      });
    }
    super.initState();
  }
              ...
              onPressed: () {
                ...
                if (controller.text.isNotEmpty) {
                  ...
                  QuranicBenefit quranicBenefit = QuranicBenefit(
                    idBenefit: widget.quranicBenefit?.idBenefit!,
                  ...
                  if (widget.quranicBenefit != null) {
                    QuranicBenefit.updateQuranicBenefit(
                        quranicBenefit, context);
